...
This module sits beside the serving controller because runtime-specific process details
must not leak into the agent/orchestration package. A healthy matching owned server is
reused, stale owned state may be stopped, and an unowned reachable endpoint is never
adopted or killed.
"""
