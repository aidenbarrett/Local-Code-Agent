...
|---|---|---|---|
| [`2026-09-08-30b-three-conditions`](2026-09-08-30b-three-conditions/) | Qwen3-Coder-30B on CPU | control, narrow, skill, plus one skill repeat | Restricting the tool set took verified completion from 3/10 to 8/10. Adding the written procedure on top changed it by zero in this smoke. |
